    ...
    <section className="relative py-28 bg-[#060D17]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-stretch">
          ...
          >
            <div>
              <span className="text-xs font-mono tracking-[0.2em] text-sky-400 uppercase block mb-2">Our Vision</span>
              <h3 className="text-2xl sm:text-4xl font-black font-display text-white mb-6">
                Navigating the Future of Marine AI
              </h3>
          ...
          >
            <div>
              <span className="text-xs font-mono tracking-[0.2em] text-blue-400 uppercase block mb-2">Our Mission</span>
